...
class DeleteStudent(Frame):
    ...
    def __init__(self, parent):
        ...
        Label(self.frame, text="Are you sure you want to permanently remove this student's information from the system?", 
            bg="#093545", fg="#FFFFFF", font=("LexendDeca Regular", 14 * -1)).place(x=35, y=285)
