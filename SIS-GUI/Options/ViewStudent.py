...
class ViewStudent(Frame):
    ...
    def __init__(self, parent):
        ...
        self.canvas.create_text(355.0, 40.0, text="VIEW STUDENT", anchor="nw", fill="#FFFFFF", font=("LexendDeca Bold", 36 * -1, "underline"))

        # creating list of student information label
        self.canvas.create_text(365.0, 106.0, text="LIST OF STUDENT INFORMATION", anchor="nw", fill="#FFFFFF", font=("LexendDeca Bold", 16 * -1))
    ...
    def view_information(self):
        ...
        self.main_frame = Frame(self.canvas, width=835, height=538, bg="#093545")
        ...
        self.table_frame = Frame(self.in_canvas, width=835, height=538, bg="#093545")
        self.in_canvas.create_window((0, 0), window=self.table_frame, anchor="nw")

        # creating no students label
        self.lblNone = Label(self.table_frame, anchor="nw", bg="#093545", fg="#FFFFFF", font=("LexendDeca Regular", 30 * -1))
